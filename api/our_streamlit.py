...
st.write("*This app takes into consideration only the I-Lead. This app is for educational purposes only and should not be used as a substitute for professional medical advice, diagnosis or treatment. For any medical questions, please consult a medical professional.")
    ...
    if response.status_code != 400:
        ...
        def generate_response(prompt):
            response = openai.ChatCompletion.create(
                model="gpt-4",  # Specify the chat-based GPT model here
